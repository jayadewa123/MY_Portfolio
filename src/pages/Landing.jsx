        ...
        <section id="home" className="landing-page" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
          <div className="landing-hero container animate-fade-in" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '50px', paddingTop: '100px', paddingBottom: '50px' }}>
            <div className="landing-text-content">
              ...
              <h2 style={{ display: 'flex', flexWrap: 'nowrap', whiteSpace: 'nowrap', alignItems: 'center', gap: '10px', margin: 0, marginBottom: '30px', fontSize: 'clamp(1rem, 2.5vw, 1.5rem)', fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700 }}>
                <span style={{ color: 'var(--text-primary)' }}>I'm a</span>
                <span className="hero-title" style={{ margin: 0, display: 'inline-block', minHeight: '1.2em', whiteSpace: 'nowrap' }}>
                  {currentText}
